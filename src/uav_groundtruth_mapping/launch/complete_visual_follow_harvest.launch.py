...
def generate_launch_description():
    ...
    follower = Node(
        ...
        condition=IfCondition(LaunchConfiguration('enable_visual_tracker')),
        ...
        parameters=[{
            ...
            'velocity_feedforward_gain': ParameterValue(
                ...
                value_type=float),
            'enable_rl_landing': ParameterValue(
                LaunchConfiguration('enable_rl_landing'), value_type=bool),
            'enable_rl_search': ParameterValue(
                LaunchConfiguration('enable_rl_search'), value_type=bool),
            'landing_start_depth': ParameterValue(
                LaunchConfiguration('landing_start_depth'), value_type=float),
            'landing_touchdown_depth': ParameterValue(
                LaunchConfiguration('landing_touchdown_depth'), value_type=float),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('enable_rl_landing', default_value='false'),
        DeclareLaunchArgument('enable_rl_search', default_value='false'),
        DeclareLaunchArgument('enable_visual_tracker', default_value='true'),
        DeclareLaunchArgument('landing_start_depth', default_value='3.0'),
        DeclareLaunchArgument('landing_touchdown_depth', default_value='0.35'),
